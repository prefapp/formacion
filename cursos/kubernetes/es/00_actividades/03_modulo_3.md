...
- Se debe crear un ingress controller en el cluster Kind, o crear el cluster con el [fichero.sh](00_solucions/03_solucion/despregar-cluster-con-registry-e-ingress.md) resultante de la [Práctica guiada Kind](03_configuracion/10_practica_guiada_tipo).

...
1. Por último, antes de hacer el `helm install` de nuestro proyecto debemos volver a lanzar el comando:
  ```shell
  $ helm dependency build
  ```
  *Si tenemos algún problema podemos borrar el archivo Chart.lock.*

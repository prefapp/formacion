...
- Nun pdf, mostrar as sentencias necesarias para:
 1. Crear os grupos de control necesarios. 
 2. Introducir limitacións de `cpu_shares` en caso de usar cgroups v1, ou de `cpu.max` en caso de usar cgroups v2. Establecendo unha ratio de limitación de 2:1.
 3. Lanzar 3 instancias do programa de test e mostrar co top as limitación de cpu. 
